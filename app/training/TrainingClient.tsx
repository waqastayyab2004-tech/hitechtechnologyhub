...
const courses = [
  ...
  },
  {
    ...
    description: 'Learn to set up and operate the Zebra GX430t desktop label printer for enterprise IT asset tagging. Covers printer setup, label media loading, QR code template configuration, and the complete asset tagging workflow — from printing to mobile scanning with the CLEA app. Based on a real 3-year SAP IT production deployment.',
    topics: [
  ...
  },
  {
    ...
    description: 'Build a production-ready ServiceNow environment from scratch — SLA frameworks (P1–P4), auto-assignment rules, business rules, KB architecture, workflow automation, and REST API integration. Based on 1,500+ tickets/year real operations experience with CSM/FSM Workspace and HCSM AI Copilot.',
    topics: [
    ...
    curriculum: [
      { module: 'Module 1 — ITSM Architecture & Process Design', lessons: [
        ...
        'SLA contract structure: IES_IRT&MPT — reading and applying contract SLAs',
      ...
      { module: 'Module 3 — Auto-Assignment Rules & Routing', lessons: [
        ...
        'Routing by location: EMEA, MENA, KSA — RUH02 routing configuration',
      ...
      { module: 'Module 4 — Business Rules, KB & Workflow Automation', lessons: [
        ...
        'Closing templates: standardised CPIT-CS closing messages with survey links',
      ]},
