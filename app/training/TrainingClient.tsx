...
const courses = [
  ...
  },
  {
    ...
    topics: [
      'Zebra ZT411 hardware overview and RFID encoder fundamentals',
      'Loading RFID inlay media and thermal transfer ribbon',
      'RFID calibration and encoder verification',
      'EU RED security activation for wireless compliance',
      'Daily asset tag printing workflow and maintenance',
    ],
    whatYouLearn: [
      'Unbox and install the Zebra ZT411 hardware safely and correctly',
      'Load RFID inlay media and thermal transfer ribbon',
      'Calibrate the RFID encoder and verify read/write to the inlay',
      'Activate the EU RED security profile for wireless compliance',
      'Print and verify SAP-format RFID asset tags in production',
    ],
    curriculum: [
      { module: 'Module 1 — RFID Printer Fundamentals & Hardware Overview', lessons: [
        ...
        'Zebra ZT411 hardware tour: print engine, RFID encoder, media path, connectivity ports',
        'Difference between thermal transfer and direct thermal printing — which to use for asset tags',
        'RFID inlay types: UHF vs. HF — SAP IT uses UHF (ISO 18000-6C / EPC Gen2)',
        'Unboxing checklist: verify all components before installation',
        'Placement guidelines: clearance, ventilation, network proximity, and cable management',
      ]},
      { module: 'Module 2 — Hardware Installation & Media Loading', lessons: [
        'Step-by-step: open media compartment and thread the label path correctly',
        'Loading RFID inlay label rolls: positioning the inlay over the RFID antenna window',
        'Thermal transfer ribbon loading: match ribbon width to media width',
        'Closing the print mechanism: correct latch tension for consistent print quality',
        'Power-on sequence and initial self-test print',
        'Common media loading errors and how to resolve them without reprinting waste',
      ]},
      { module: 'Module 3 — RFID Calibration & Encoder Setup', lessons: [
        'Why RFID calibration is required after every media change',
        'Running the RFID calibration routine via the ZT411 front panel',
        'RFID read/write verification: confirming the encoder programmes the inlay correctly',
        'Adjusting RFID power level for optimal read range without interference',
        'Testing with Zebra Setup Utilities: send a test label, verify RFID data in the tag',
        'Troubleshooting void labels: causes and corrective actions',
      ]},
      { module: 'Module 4 — EU RED Security Activation & Compliance', lessons: [
        'What is EU RED and why SAP mandates it for wireless devices',
        'Locating the EU RED security settings on the ZT411',
        'Step-by-step: activate the EU RED security profile',
        'Verifying activation: confirming the printer operates within approved frequency bands',
        'SAP global wireless compliance policy: what happens if a non-compliant device is found',
        'Documentation: record the activation in the asset management system',
      ]},
      { module: 'Module 5 — Daily Operations & Asset Tag Printing', lessons: [
        'SAP IT asset tagging workflow: from procurement to RFID tag to assignment',
        'Printing asset tags: selecting the correct label format and RFID data structure',
        'Label quality checks: scan every tag before applying it to a device',
        'Applying RFID tags correctly: surface preparation, placement, orientation',
        'Daily printer maintenance: printhead cleaning, platen roller inspection',
        'Following SAP KB1349185 (printer setup) and KB1349678 (label printing guide)',
      ]},
    ],
  },
  {
