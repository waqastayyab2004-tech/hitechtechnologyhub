...
const courses = [
  ...
  { id: 123, title: 'Nexthink Amplify: Real-Time Endpoint Visibility for IT Support', category: 'AI & Emerging Tech', level: 'Intermediate', duration: '2h', students: '65+', rating: 4.9, isFree: false, isPopular: true, img: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80&auto=format&fit=crop', skills: ['Nexthink Amplify', 'Endpoint Analytics', 'Remote Actions', 'ITSM Integration', 'FCR Improvement', 'Proactive IT', 'MTTR Reduction', 'Digital Workplace'], description: 'Nexthink Amplify is a browser-based plugin that integrates real-time endpoint telemetry, AI diagnostics, and one-click remote actions directly into your ITSM ticketing tool. This course covers the full Amplify workflow — from understanding the architecture to using remote actions, interpreting telemetry, and improving First Contact Resolution at the service desk.', whatYouLearn: ['Understand how Nexthink Amplify integrates with your ITSM platform and surfaces endpoint data inside tickets', 'Interpret real-time device telemetry: CPU, memory, crashes, boot time, network, compliance', 'Use one-click remote actions to resolve common issues without remote desktop', 'Apply guided diagnostics to improve First Contact Resolution at L1', 'Identify proactive signals — crash spikes, compliance drift — before users raise tickets'], curriculum: [
