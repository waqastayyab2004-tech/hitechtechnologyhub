...
const courses = [
  ...
  {
    id: 112,
    title: 'Password Security & Generator: Build Compliant Passwords with Python',
    category: 'Corporate IT Training',
    level: 'Beginner', duration: '1h 30m', students: '90+', rating: 4.9,
    isFree: true, isPopular: true,
    img: 'https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=400&q=80&auto=format&fit=crop',
    instructor: 'Syed Waqas Tayyab',
    skills: ['Password Policy', 'Python', 'Cybersecurity Compliance', 'Passphrase Design', 'SQLite', 'Tkinter', 'PyInstaller'],
    description: 'Learn how to design, build, and deploy a cybersecurity-compliant password generator in Python — covering password policy enforcement, entropy, memorable passphrase techniques, and packaging as a standalone macOS app. Based on a real app built and shipped by the instructor.',
    topics: [
      'Enterprise password policy: length, complexity, expiry, and compliance',
      'Password entropy: why random strings beat predictable patterns',
      'Memorable passphrase design: strong yet easy to remember',
      'Build a Python/Tkinter password generator from scratch',
      'Package as a standalone macOS .app with PyInstaller',
    ],
    curriculum: [
      { module: 'Module 1 — Password Policy & Cybersecurity Compliance', lessons: ['Why passwords are still the #1 attack vector in enterprise IT', 'Enterprise password policy: 15-char minimum, complexity requirements', 'What makes a password compliant: uppercase + lowercase + digit + symbol', 'Password expiry policy: 2-year cycle, admin account rules', 'Common password mistakes employees make — and how to fix them'] },
      { module: 'Module 2 — Password Entropy & Strength Theory', lessons: ['What is password entropy and how it is calculated', 'Why length matters more than complexity alone', 'Brute-force time estimates: 8 chars vs 15 chars vs 20 chars', 'Dictionary attacks: why common words and patterns fail', 'Memorable passphrases vs random strings — a practical comparison'] },
      { module: 'Module 3 — Memorable Password Design', lessons: ['The passphrase method: combining unrelated words for strength', 'Word list design: which words make good passphrase components', 'Adding digits and symbols to passphrases without losing memorability', 'How to hint at a strong password without storing it unsafely', 'Corporate passphrase training: what to teach employees'] },
      { module: 'Module 4 — Build the Password Generator in Python', lessons: ['Project setup: Python 3, Tkinter, SQLite3 — no extra libraries needed', 'Building the GUI: window, label, entry, dropdown, checkboxes, buttons', 'Password generation logic: character pool + random.choice()', 'Three modes: Strong (full charset), Medium (letters+digits), Memorable (words)', 'Storing history in SQLite at ~/Library/Application Support — secure local storage'] },
      { module: 'Module 5 — Package & Ship as a macOS App', lessons: ['Why PyInstaller is the right tool for standalone Python apps', 'Creating the .spec file: onefile, windowed, icon configuration', 'Handling paths in packaged apps: os.path.expanduser() vs hardcoded paths', 'Building and testing the .app bundle on macOS (arm64)', 'Distribution: .dmg creation and sharing with end users'] },
    ],
  },
  {
    id: 1,
