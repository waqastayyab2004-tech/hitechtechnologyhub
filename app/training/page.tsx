...
const categories = ['All', 'Career & IT Foundations', 'Microsoft 365 & Azure', 'Cybersecurity & Azure', 'ITSM & ServiceNow', 'AI & Automation', 'IT Infrastructure']

const stats = [
  { v: '8', l: 'Courses Available', c: 'text-accent-blue' },
  { v: '2,000+', l: 'Students Trained', c: 'text-green-400' },
  { v: '4.9★', l: 'Average Rating', c: 'text-yellow-400' },
  { v: '3', l: 'Free Courses', c: 'text-purple-400' },
]
