      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-dark-800/50 border-y border-white/8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative rounded-2xl overflow-hidden" style={{background:'linear-gradient(135deg,#0a1628 60%,#0d2040 100%)'}}>
            <div className="absolute inset-0 opacity-10" style={{backgroundImage:'repeating-linear-gradient(120deg,transparent,transparent 40px,rgba(239,68,68,0.3) 40px,rgba(239,68,68,0.3) 41px)'}}/>
            <div className="relative z-10 flex flex-col md:flex-row items-stretch">

              {/* Left — info */}
              <div className="flex-1 p-8 md:p-10">
                <h3 className="text-2xl font-black text-white mb-1">Mujahid Hussain</h3>
                <p className="text-rose-400 font-semibold text-sm mb-1">Team Lead Operations · Medical Billing & RCM Specialist</p>
                <p className="text-gray-500 text-xs mb-6">Bellmedex Medical Billing Company · 2021 – Present</p>
                ...
                <div className="flex flex-wrap gap-8 mb-6 pb-6 border-b border-white/8">
                  {[
                    ...
                    <div key={s.l}>
                      ...
                      <div className="text-gray-500 text-xs mt-0.5 max-w-[100px] leading-snug">{s.l}</div>
                    </div>
                  ))}
                </div>

                <p className="text-gray-300 text-sm leading-relaxed mb-5">
                  A highly motivated and results-driven RCM professional with deep expertise in Medical Billing, AR management, denial resolution, and billing team leadership. Currently serving as Team Lead Operations at Bellmedex Medical Billing Company — supervising billing teams, training staff, and driving revenue cycle performance for US healthcare practices across multiple specialties.
                </p>

                {/* Experience highlights */}
                <div className="space-y-2 mb-6">
                  {[
                    'AR Specialist & Team Lead at Bellmedex Medical Billing (2021–Present)',
                    'Account Operations Manager at MTBC (2020–2021)',
                    'Supervises and guides team members in all billing tasks and procedures',
                    'Conducts meetings with providers on practice performance and payments',
                    'Trained in VOB, payment posting, denial management, and claim appeals',
                  ].map((p, i) => (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {['AR Management', 'Denial Management', 'Payment Posting', 'VOB', 'Prior Auth', 'Appeals', 'Claim Rejection', 'Team Leadership'].map(s => (
                ...
                {/* Specialties */}
                <div className="mb-6">
                  <p className="text-[10px] text-gray-600 uppercase tracking-widest font-semibold mb-2">Specialties Handled</p>
                  <div className="flex flex-wrap gap-1.5">
                    {['Mental Health', 'Internal Medicine', 'Chiropractic', 'Family Medicine', 'Transportation / NEMT', 'DME'].map(s => (
                      <span key={s} className="px-2.5 py-1 rounded-full text-[10px] font-semibold bg-accent-blue/10 border border-accent-blue/20 text-accent-blue">{s}</span>
                    ))}
                  </div>
                </div>

                {/* Education */}
                <div className="mb-6 pt-5 border-t border-white/8">
                  <p className="text-[10px] text-gray-600 uppercase tracking-widest font-semibold mb-2">Education</p>
                  <p className="text-sm text-gray-400">BS Computer Science — University of AJK Muzaffarabad</p>
                </div>

                {/* Contact CTA */}
                <div className="pt-5 border-t border-white/8">
                  <p className="text-gray-200 font-medium text-sm max-w-sm leading-snug mb-4">
                    Ready to assess your billing challenge and improve your revenue cycle. Schedule a call to start.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <a href="https://wa.me/923451525845" target="_blank" rel="noopener noreferrer"
                      className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-green-500/10 border border-green-500/30 text-green-400 text-sm font-bold hover:bg-green-500/20 transition-colors">
                    ...
                    <a href="mailto:adnanhamdani32@gmail.com"
                      className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-400 text-sm font-bold hover:bg-rose-500/20 transition-colors">
              ...
              <div className="relative md:w-72 flex-shrink-0 flex items-end justify-center overflow-hidden"
                ...
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/mujahid-billing-expert.jpg" alt="Mujahid Hussain — Medical Billing Expert"
                  className="w-full h-80 md:h-full object-cover object-top"
                  style={{objectPosition:'center 0%'}}/>
                <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#071020] to-transparent"/>
                <div className="absolute top-0 left-0 bottom-0 w-8 bg-gradient-to-r from-[#0a1628] to-transparent"/>
              </div>
