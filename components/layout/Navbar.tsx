    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Desktop nav — only show at lg+ (1024px), hamburger below */}
          ...
          {/* Open to Work — lg+ only */}
          <div className="hidden lg:flex items-center gap-2">
            <span className="flex items-center gap-1.5 text-xs text-green-400 font-medium whitespace-nowrap">
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="lg:hidden bg-dark-800/95 backdrop-blur-md border-b border-white/5"
          >
